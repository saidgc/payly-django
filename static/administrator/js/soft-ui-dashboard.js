...
function sidebarColor(e) {
    ...
    document.querySelector("#sidenavCard") && (t = ["card", "card-background", "shadow-none", "card-background-mask-" + n],
...
function darkMode(e) {
    ...
    if (e.getAttribute("checked")) {
        ...
        for (C = 0; C < q.length; C++)
            q[C].classList.add("blur");
        for (C = 0; C < a.length; C++)
            a[C].classList.contains("light") && (a[C].classList.add("dark"),
        ...
        x.includes("logo-ct-dark.png") && (B = x.replace("logo-ct-dark", "logo-ct"),
        w.src = B);
        ...
        for (var C = 0; C < q.length; C++)
            q[C].classList.contains("blur") && q[C].classList.remove("blur");
        ...
        for (var C = 0; C < a.length; C++)
            a[C].classList.contains("dark") && (a[C].classList.remove("dark"),
        ...
        for (var C = 0; C < c.length; C++)
            c[C].classList.contains("text-dark") && (c[C].classList.remove("text-dark"),
            c[C].classList.add("text-white"));
        for (var C = 0; C < u.length; C++)
            u[C].classList.contains("text-dark") && (u[C].classList.remove("text-dark"),
            u[C].classList.add("text-white"));
        for (var C = 0; C < g.length; C++)
            g[C].classList.contains("text-secondary") && (g[C].classList.remove("text-secondary"),
            g[C].classList.add("text-white"),
            g[C].classList.add("opacity-8"));
        for (var C = 0; C < m.length; C++)
            m[C].classList.contains("bg-gray-100") && (m[C].classList.remove("bg-gray-100"),
            m[C].classList.add("bg-gray-600"));
        for (var C = 0; C < f.length; C++)
            f[C].classList.remove("text-dark"),
            f[C].classList.add("text-white");
        for (var C = 0; C < i.length; C++)
            i[C].classList.remove("bg-white");
        for (var C = 0; C < p.length; C++)
            p[C].hasAttribute("fill") && p[C].setAttribute("fill", "#6c757d");
